...
# Load images
snake_image = pygame.image.load("X:/Python/Music Player Project/Final/Music Player/icons/theme1.jpg")
food_image = pygame.image.load("X:/Python/Music Player Project/Final/Music Player/icons/theme2.jpg")
